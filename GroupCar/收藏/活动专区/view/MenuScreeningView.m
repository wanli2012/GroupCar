...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.oneLinkageButton.frame = CGRectMake(0, 0, kWidth/4, 45);
        ...
        self.twoLinkageButton.frame = CGRectMake(kWidth/4, 0, kWidth/4, 45);
        [self setUpButton:self.twoLinkageButton withText:@"品牌"];
        ...
        self.threeLinkageButton.frame = CGRectMake(2 * kWidth/4, 0,  kWidth/4, 45);
        [self setUpButton:self.threeLinkageButton withText:@"首府"];
